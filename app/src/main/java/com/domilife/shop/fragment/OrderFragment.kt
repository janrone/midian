...
import com.domilife.shop.activity.OrderDetailActivity
import com.domilife.shop.activity.ProductActivity
import com.domilife.shop.adapter.OrderAdapter
...
class OrderFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun initView() {
        ...
        mCommonAdapter = OrderAdapter(activity, mList, mTitle)

        mCommonAdapter?.setOnClickListener(object :OrderAdapter.ShareListener{
