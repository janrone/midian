...
object RetrofitManager{
    ...
    val service: ApiManager by lazy (LazyThreadSafetyMode.SYNCHRONIZED){
        getRetrofit().create(ApiManager::class.java)
    }
    ...
    private fun addCacheInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            if (!NetworkUtil.isNetworkAvailable(DMApplication.context)) {
    ...
    private fun getOkHttpClient(): OkHttpClient {
        ...
        //设置 请求的缓存的大小跟位置
        val cacheFile = File(DMApplication.context.cacheDir, "cache")
