...
@Parcelize
class HomePageBean (val isCompQuality:Int, val isCompShopMsg:Int, var qrCodeUrl:String,
                    var shopGallarys:List<ShopGallaryBean>, var showToasts:List<HomeToastBean>) : Parcelable